...
import { Copy, Check, RefreshCw, AlertCircle, User, Sparkles, Ban, FileCheck, FileText, FileSpreadsheet, FileCode, Presentation, ChevronDown, Brain, Wrench, ChevronRight, BookOpen } from 'lucide-vue-next'
import { useMarkdown } from '@/composables/useMarkdown'
import type { ToolCallRecord, ArtifactFile, KbReference } from '@/types/domain'
