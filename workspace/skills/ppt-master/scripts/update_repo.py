...
def main(argv: list[str] | None = None) -> int:
    print_status(
        "update_repo.py is disabled in QuanAgent's vendored PPT Master copy. "
        "Use the controlled upgrade procedure recorded in VENDOR.json instead."
    )
    return 2

    # Kept below as upstream reference code for controlled snapshot upgrades.
