...
3.1. Read [`references/quanagent-host.md`](references/quanagent-host.md). This
   is mandatory for every route and owns QuanAgent-specific paths, providers,
   and confirmation-page behavior.
