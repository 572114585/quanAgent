    ...
    spec: dict[str, Any] = {
        ...
        "selfCorrectLoop": {
            ...
            "screenshotPolicy": {
                ...
                "preferredCapture": "render_html-tool",
                "fallbackCapture": "user-supplied-screenshot-path-only-if-user-provides-png",
                ...
                "captureNote": "DeepAgent: call render_html on packaged output/*.html. Never start http.server or a second browser.",
            },
        },
